...
public class GlobalParams {
    ...
    public void initializeGlobalParams() throws IOException {
        ...
        params.setPlatformName(System.getProperty("platform", String.valueOf(props.getProps().entrySet().iterator().next().getValue())));
        params.setUDID(System.getProperty("udid", String.valueOf(props.getProps().entrySet().iterator().next().getValue())));
        params.setDeviceName(System.getProperty("deviceName", String.valueOf(props.getProps().entrySet().iterator().next().getValue())));
